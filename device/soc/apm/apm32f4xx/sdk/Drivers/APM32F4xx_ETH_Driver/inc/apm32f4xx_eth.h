...
/** @addtogroup ETH_Driver ETH Driver
  @{
*/

/** @addtogroup ETH_Enumerations Enumerations
  @{
*/
...
typedef enum
{
    ETH_INTERFRAMEGAP_96BIT = 0x00,
    ETH_INTERFRAMEGAP_88BIT = 0x01,
    ETH_INTERFRAMEGAP_80BIT = 0x02,
    ETH_INTERFRAMEGAP_72BIT = 0x03,
    ETH_INTERFRAMEGAP_64BIT = 0x04,
    ETH_INTERFRAMEGAP_56BIT = 0x05,
    ETH_INTERFRAMEGAP_48BIT = 0x06,
    ETH_INTERFRAMEGAP_40BIT = 0x07
}ETH_INTERFRAMEGAP_T;
...
typedef enum
{
    ...
    ETH_SOURCEADDRFILTER_NORMAL_ENABLE = BIT9,
    ETH_SOURCEADDRFILTER_INVERSE_ENABLE = BIT8|BIT9,
...
typedef enum
{
    ETH_PASSCONTROLFRAMES_BLOCKALL = 1,
...
typedef enum
{
    ...
    ETH_MULTICASTFRAMESFILTER_NONE = BIT4,
    ETH_MULTICASTFRAMESFILTER_HASHTABLE = BIT2,
    ETH_MULTICASTFRAMESFILTER_PERFECTHASHTABLE = BIT2|BIT10
...
typedef enum
{
    ...
    ETH_UNICASTFRAMESFILTER_HASHTABLE = BIT1,
    ETH_UNICASTFRAMESFILTER_PERFECTHASHTABLE = BIT1|BIT10
...
typedef enum
{
    ETH_MAC_FLAG_TST  = 0x00000200,
    ETH_MAC_FLAG_MMCT = 0x00000040,
    ETH_MAC_FLAG_MMCR = 0x00000020,
    ETH_MAC_FLAG_MMC  = 0x00000010,
    ETH_MAC_FLAG_PMT  = 0x00000008
}ETH_MAC_FLAG_T;
...
typedef enum
{
    ETH_MAC_INT_TST  = 0x00000200,
    ETH_MAC_INT_MMCT = 0x00000040,
    ETH_MAC_INT_MMCR = 0x00000020,
    ETH_MAC_INT_MMC  = 0x00000010,
    ETH_MAC_INT_PMT  = 0x00000008
}ETH_MAC_INT_T;
...
typedef enum
{
    ETH_MAC_ADDRESS0 = 0x00000000,
    ETH_MAC_ADDRESS1 = 0x00000008,
    ETH_MAC_ADDRESS2 = 0x00000010,
    ETH_MAC_ADDRESS3 = 0x00000018
}ETH_MAC_ADDRESS_T;
...
typedef enum
{
    ...
    ETH_MAC_ADDRESSFILTER_DA = BIT30
...
typedef enum
{
    ETH_DMATXDESC_OWN      = (int)0x80000000,
    ETH_DMATXDESC_INTC     = 0x40000000,
    ETH_DMATXDESC_LS       = 0x20000000,
    ETH_DMATXDESC_FS       = 0x10000000,
    ETH_DMATXDESC_DISC     = 0x08000000,
    ETH_DMATXDESC_DISP     = 0x04000000,
    ETH_DMATXDESC_TXTSEN   = 0x02000000,
    ETH_DMATXDESC_TXENDR   = 0x00200000,
    ETH_DMATXDESC_TXCH     = 0x00100000,
    ETH_DMATXDESC_TXTSS    = 0x00020000,
    ETH_DMATXDESC_IHERR    = 0x00010000,
    ETH_DMATXDESC_ERRS     = 0x00008000,
    ETH_DMATXDESC_JTO      = 0x00004000,
    ETH_DMATXDESC_FF       = 0x00002000,
    ETH_DMATXDESC_IPERR    = 0x00001000,
    ETH_DMATXDESC_LSC      = 0x00000800,
    ETH_DMATXDESC_NC       = 0x00000400,
    ETH_DMATXDESC_LC       = 0x00000200,
    ETH_DMATXDESC_EC       = 0x00000100,
    ETH_DMATXDESC_VLANF    = 0x00000080,
    ETH_DMATXDESC_CCNT     = 0x00000078,
    ETH_DMATXDESC_EDEF     = 0x00000004,
    ETH_DMATXDESC_UFERR    = 0x00000002,
    ETH_DMATXDESC_DEF      = 0x00000001
...
typedef enum
{
    ETH_DMATXDESC_LASTSEGMENTS = BIT30,
    ETH_DMATXDESC_FIRSTSEGMENT = BIT29
...
typedef enum
{
    ...
    ETH_DMATXDESC_CHECKSUMIPV4HEADER = BIT22,
    ETH_DMATXDESC_CHECKSUMTCPUDPICMPSEGMENT = BIT23,
    ETH_DMATXDESC_CHECKSUMTCPUDPICMPFULL = BIT22|BIT23
...
typedef enum
{
    ETH_DMARXDESC_OWN      =  (int)0x80000000U,
    ETH_DMARXDESC_ADDRF    =  0x40000000,
    ETH_DMARXDESC_ERRS     =  0x00008000,
    ETH_DMARXDESC_DESERR   =  0x00004000,
    ETH_DMARXDESC_SADDRF   =  0x00002000,
    ETH_DMARXDESC_LERR     =  0x00001000,
    ETH_DMARXDESC_OFERR    =  0x00000800,
    ETH_DMARXDESC_VLANF    =  0x00000400,
    ETH_DMARXDESC_FDES     =  0x00000200,
    ETH_DMARXDESC_LDES     =  0x00000100,
    ETH_DMARXDESC_IPV4HCE  =  0x00000080,
    ETH_DMARXDESC_LC       =  0x00000040,
    ETH_DMARXDESC_FT       =  0x00000020,
    ETH_DMARXDESC_RXWDTTO  =  0x00000010,
    ETH_DMARXDESC_RERR     =  0x00000008,
    ETH_DMARXDESC_DERR     =  0x00000004,
    ETH_DMARXDESC_CERR     =  0x00000002,
    ETH_DMARXDESC_MAMPCE   =  0x00000001
...
typedef enum
{
    ETH_DMAPTPRXDESC_PTPV   =  0x00002000,
    ETH_DMAPTPRXDESC_PTPFT  =  0x00001000,
    ETH_DMAPTPRXDESC_PTPMT  =  0x00000F00,
    ETH_DMAPTPRXDESC_IPV6P  =  0x00000080,
    ETH_DMAPTPRXDESC_IPV4P  =  0x00000040,
    ETH_DMAPTPRXDESC_IPCBP  =  0x00000020,
    ETH_DMAPTPRXDESC_IPPERR =  0x00000010,
    ETH_DMAPTPRXDESC_IPHERR =  0x00000008,
    ETH_DMAPTPRXDESC_IPPT   =  0x00000007
...
typedef enum
{
    ETH_RXDMABURSTLENGTH_1BEAT        = BIT17,
    ETH_RXDMABURSTLENGTH_2BEAT        = BIT18,
    ETH_RXDMABURSTLENGTH_4BEAT        = BIT19,
    ETH_RXDMABURSTLENGTH_8BEAT        = BIT20,
    ETH_RXDMABURSTLENGTH_16BEAT       = BIT21,
    ETH_RXDMABURSTLENGTH_32BEAT       = BIT22,
    ETH_RXDMABURSTLENGTH_4XPBL_4BEAT  = BIT17|BIT24,
    ETH_RXDMABURSTLENGTH_4XPBL_8BEAT  = BIT18|BIT24,
    ETH_RXDMABURSTLENGTH_4XPBL_16BEAT = BIT19|BIT24,
    ETH_RXDMABURSTLENGTH_4XPBL_32BEAT = BIT20|BIT24,
    ETH_RXDMABURSTLENGTH_4XPBL_64BEAT = BIT21|BIT24,
    ETH_RXDMABURSTLENGTH_4XPBL_128BEAT= BIT22|BIT24
...
typedef enum
{
    ETH_TXDMABURSTLENGTH_1BEAT        = BIT8,
    ETH_TXDMABURSTLENGTH_2BEAT        = BIT9,
    ETH_TXDMABURSTLENGTH_4BEAT        = BIT10,
    ETH_TXDMABURSTLENGTH_8BEAT        = BIT11,
    ETH_TXDMABURSTLENGTH_16BEAT       = BIT12,
    ETH_TXDMABURSTLENGTH_32BEAT       = BIT13,
    ETH_TXDMABURSTLENGTH_4XPBL_4BEAT  = BIT8|BIT24,
    ETH_TXDMABURSTLENGTH_4XPBL_8BEAT  = BIT9|BIT24,
    ETH_TXDMABURSTLENGTH_4XPBL_16BEAT = BIT10|BIT24,
    ETH_TXDMABURSTLENGTH_4XPBL_32BEAT = BIT11|BIT24,
    ETH_TXDMABURSTLENGTH_4XPBL_64BEAT = BIT12|BIT24,
    ETH_TXDMABURSTLENGTH_4XPBL_128BEAT= BIT13|BIT24
...
typedef enum
{
    ...
    ETH_DMAARBITRATION_ROUNDROBIN_RXTX_2_1 = BIT14,
    ETH_DMAARBITRATION_ROUNDROBIN_RXTX_3_1 = BIT15,
    ETH_DMAARBITRATION_ROUNDROBIN_RXTX_4_1 = BIT14|BIT15,
    ETH_DMAARBITRATION_RXPRIORTX = BIT1
...
typedef enum
{
    ...
    ETH_DMA_TRANSMITPROCESS_SUSPENDED = 0x06 ,
    ETH_DMA_TRANSMITPROCESS_CLOSING = 0x07,
...
typedef enum
{
    ...
    ETH_DMA_RECEIVEPROCESS_FETCHING  = 0x02,
    ETH_DMA_RECEIVEPROCESS_WAITING   = 0x06,
    ETH_DMA_RECEIVEPROCESS_SUSPENDED = 0x08,
    ETH_DMA_RECEIVEPROCESS_CLOSING   = 0x0A,
    ETH_DMA_RECEIVEPROCESS_QUEUING   = 0x0E
...
typedef enum
{
    ETH_DMA_OVERFLOW_RXFIFOCOUNTER = BIT28,
    ETH_DMA_OVERFLOW_MISSEDFRAMECOUNTER = BIT16
}ETH_DMA_OVERFLOW_T;
...
typedef enum
{
    ETH_PMT_FLAG_WUFFRPR = (int)BIT31,
    ETH_PMT_FLAG_WUFR = BIT6,
    ETH_PMT_FLAG_MPR = BIT5
}ETH_PMT_FLAG_T;
...
typedef enum
{
    ETH_MMC_INT_TGF    = BIT21,
    ETH_MMC_INT_TGFMSC = BIT15,
    ETH_MMC_INT_TGFSC  = BIT14,
    ETH_MMC_INT_RGUF   = BIT21|BIT30,
    ETH_MMC_INT_RFAE   = BIT6|BIT30,
    ETH_MMC_INT_RFCE   = BIT5|BIT30
}ETH_MMC_INT_T;
...
typedef enum
{
    ETH_MMC_CTRL       =  0x00000100,
    ETH_MMC_RXINT      =  0x00000104,
    ETH_MMC_TXINT      =  0x00000108,
    ETH_MMC_RXINTMASK  =  0x0000010C,
    ETH_MMC_TXINTMASK  =  0x00000110,
    ETH_MMC_TXGFSCCNT  =  0x0000014C,
    ETH_MMC_TXGFMCCNT  =  0x00000150,
    ETH_MMC_TXGFCNT    =  0x00000168,
    ETH_MMC_RXFCECNT   =  0x00000194,
    ETH_MMC_RXFAECNT   =  0x00000198,
    ETH_MMC_RXGUNCNT   =  0x000001C4
}ETH_MMC_REG_T;
...
#if defined (APM32F407_EVAL)
#define PHY_SR                                       31        //!< Transceiver Status Register for LAN8720
#else
...
#if defined (APM32F407_EVAL)
#define PHY_DUPLEX_STATUS               ((uint16_t)0x0010)     //!< for LAN8720 
#define PHY_SPEED_STATUS                ((uint16_t)0x0004)     //!< for LAN8720 
#else
#define PHY_DUPLEX_STATUS               ((uint16_t)0x0004)     //!< for dp83848 
#define PHY_SPEED_STATUS                ((uint16_t)0x0002)     //!< for dp83848 
#endif
...
typedef struct
{
    uint32_t        length;
    uint32_t        buffer;
    __IO ETH_DMADescConfig_T *descriptor;
}ETH_Frame_T;
...
/** @addtogroup ETH_Fuctions Fuctions
  @{
*/
